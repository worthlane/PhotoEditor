...
bool onLoadPlugin()
{
    ...
    auto helpbar = std::make_unique<SubMenuBar>(kHelpBarWindowId,
                                         psapi::vec2i(360, 30),
    ...
    auto helpbutton = std::make_unique<CallSubMenuButton>(psapi::kMenuHelpId, menu,
                                                        psapi::vec2i(360, 0),
                                                        psapi::vec2u(90, 30),
                                                        help_name, psapi::sfm::Color(255, 255, 255),
                                                        std::move(helpbar));

    menu->addWindow(std::move(helpbutton));
}
