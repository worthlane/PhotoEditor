...
plugins:
	...
	$(CXX) -dynamiclib plugins/menubar/filters/filters.cpp plugins/menubar/filters/filtersbar.cpp -o $(BUILD_DIR)/filters.dll $(CXXFLAGS) $(LOCATION_FLAG) $(BUILD_DIR)/libapi_photoshop.dll
	...
	$(CXX) -dynamiclib plugins/menubar/files/filebar.cpp plugins/menubar/files/import.cpp -o $(BUILD_DIR)/files.dll $(CXXFLAGS) $(LOCATION_FLAG) $(BUILD_DIR)/libapi_photoshop.dll
