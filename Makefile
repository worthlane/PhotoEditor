...
plugins:
	...
	$(CXX) -dynamiclib plugins/filters.cpp plugins/catmull.cpp plugins/toolbar_button.cpp -o $(BUILD_DIR)/filters.dll $(CXXFLAGS) $(LOCATION_FLAG) $(BUILD_DIR)/libapi_photoshop.dll
